...
async function connectDatabase(){
    ...
    //   let result = await mongoose.connect(process.env.DBURL)
      let result = await mongoose.connect(`mongodb+srv://Hitakshi:Hitakshi@hitakshi0624be21.0o1qptm.mongodb.net/LMS?retryWrites=true&w=majority&appName=hitakshi0624be21
      `)
    //    console.log(result)
