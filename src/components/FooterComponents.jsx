    ...
    return (
        <Box gridColumn="12/25" display="flex" flexWrap="wrap">
            <Box width="33%" marginBottom="40px">
                ...
                <Link href="https://unacademy.com/about" marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">About us</Link>
                <Link href="https://unacademy.com/shikshodaya" marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">Shikshodaya</Link>
                    <Link href=" https://unacademy.com/careers"marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" display="flex" alignItems="center" backgroundColor="transparent">
                    ...
                    <Link href="https://blog.unacademy.com/" marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">Blogs</Link>
                    <Link  href="https://unacademy.com/privacy"marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">Privacy Policy</Link>
                    <Link href="https://unacademy.com/terms" marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">Terms and Conditions</Link>
            ...
            <Box width="33%" marginBottom="40px">
                ...
                <Box display="flex" flexDirection="column" >
                    <Link href="https://unacademy.com/guidelines" marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">User Guidelines</Link>
                    <Link href="https://unacademy.com/sitemap" marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">Site Map</Link>
                    <Link  href="https://unacademy.com/refund-policy" marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">Refund Policy</Link>
                    <Link href="https://unacademy.com/takedown-policy" marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">Takedown Policy</Link>
                    <Link href="https://unacademy.com/ugrc" marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">Grievance Redressal</Link>
            ...
            <Box width="33%" marginBottom="40px">
                ...
                <Box display="flex" flexDirection="column" >
                    <Link href="https://unacademy.com/goal/jee-main-and-advanced-preparation/TMUVD" marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">IIT JEE</Link>
                    <Link  href="https://unacademy.com/goal/upsc-civil-services-examination-ias-preparation/KSCGY"marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">UPSC</Link>
                    <Link href="https://unacademy.com/goal/ssc-exams-non-technical-railway-exams/VLEMN" marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">SSC</Link>
                    <Link href="https://unacademy.com/goal/csir-ugc-net/BIZXQ" marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">CSIR UGC NET</Link>
                    <Link href="https://unacademy.com/goal/neet-ug/YOTUH" marginBottom="8px" lineHeight="150%" color="#7A8B94" fontSize="14px" fontWeight="normal" transition="color 200ms ease-in-out" backgroundColor="transparent">NEET UG</Link>
